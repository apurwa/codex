...
impl ChatComposer {
    ...
    pub(crate) fn set_active_reasoning_effort(
            ...
            && animations_enabled
        {
            ...
            if self.footer.status_line_enabled
                && !self.footer.status_line_values.is_empty()
    ...
    fn footer_props(&self) -> FooterProps {
        ...
        FooterProps {
            ...
            is_wsl,
            status_line_values: self.footer.status_line_values.clone(),
    ...
    pub(crate) fn set_status_lines(&mut self, status_lines: Vec<Line<'static>>) -> bool {
        if self.footer.status_line_values == status_lines {
            return false;
        }
        self.footer.status_line_values = status_lines;
        true
    }
