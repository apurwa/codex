...
pub struct Config {
    ...
    /// Ordered status-line rows for the TUI.
    ///
    /// When set, this takes precedence over `tui_status_line`.
    pub tui_status_lines: Option<Vec<Vec<String>>>,
...
impl Config {
    ...
    pub(crate) async fn load_config_with_layer_stack(
        ...
        let config = Self {
            ...
            tui_status_lines: cfg.tui.as_ref().and_then(|t| t.status_lines.clone()),
